...
#define DECOMPRESSOR_LIST     { ".gz", "gunzip -c %s", ".Z", "zcat %s", ".zip", "unzip -p %s", ".lha", "lha -pq %s", ".lzh", "lha -pq %s", ".shn", "shorten -x %s -", ".wav", "wav2pat %s", 0 }
...
#define PATCH_EXT_LIST        { ".pat", ".shn", ".pat.shn", ".gz", ".pat.gz", 0 }
